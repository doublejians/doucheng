	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null
			...
			holder.dateTv = (TextView) convertView
					.findViewById(R.id.startend_date);
			...
			holder.endTv = (TextView) convertView
					.findViewById(R.id.event_endtxt);

			holder.wisherTv = (TextView) convertView
					.findViewById(R.id.event_wishercount);
			holder.ownerTv = (TextView) convertView
					.findViewById(R.id.event_owner);
